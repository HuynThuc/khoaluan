...
const Header = () => {
  ...
  return (
    <header className="absolute left-0 top-0 w-full z-99">
      <nav className="max-w-screen-xl mx-auto flex items-center justify-between ">
        <div className="nav__logo max-w-[150px] ">
          <a href="/"><img src={logo} alt="Logo" /></a>
        </div>
        <ul className="nav__links list-none text-white flex items-center gap-12">
        ...
        {/* Hiển thị biểu tượng người dùng nếu người dùng đã đăng nhập */}
        {user ? (
